...
description: |
  This project analyzes a small subset of colleges in the US in order to establish a correlation between the performance of the undergraduates of these colleges in high school, and their mid-career median salary.
...
college_top10_salary_gpa_plot2 <- college_top10_salary_gpa %>%
  ggplot(mapping = aes(x = avg_gpa,
    ...
    geom_point() +
    labs(title = "High School Performance and Predicted Future Salary, by College",
         x = "Average high school GPA of admitted undergraduates",
         y = "Mid-Career Median Salary")
ggplotly(college_top10_salary_gpa_plot2)
```

## Overall Trend
There is a roughly positive correlation between 